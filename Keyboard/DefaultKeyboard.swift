...
func defaultKeyboard() -> Keyboard {
    ...
    defaultKeyboard.addKey(backspace, row: row, page: 0)
    ...
    defaultKeyboard.addKey(keyModeChangeNumbers, row: row, page: 0)
    
    let keyboardChange = Key(.KeyboardChange)
    defaultKeyboard.addKey(keyboardChange, row: row, page: 0)
    
    let settings = Key(.Settings)
    defaultKeyboard.addKey(settings, row: row, page: 0)
    
    let space = Key(.Space)
    space.uppercaseKeyCap = "space"
    space.uppercaseOutput = " "
    space.lowercaseOutput = " "
    defaultKeyboard.addKey(space, row: row, page: 0)
    
    let returnKey = Key(.Return)
    returnKey.uppercaseKeyCap = "return"
    returnKey.uppercaseOutput = "\n"
    returnKey.lowercaseOutput = "\n"
    defaultKeyboard.addKey(returnKey, row: row, page: 0)
